...
public class Board implements Serializable{
	...
	public String toString() {
		return "[boardNo=" + boardNo + ", boardTitle=" + boardTitle + ", boardWriter=" + boardWriter + ", boardContent="
				+ boardContent + ", boardDate=" + boardDate + ", readCount=" + readCount + ", fileCount=" + fileCount
				+ ", files=" + files + "]";
	}
